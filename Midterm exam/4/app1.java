...
public class app1{
        ...
        public static void input_data(String name[],String sex[],String yo[],String id[])throws IOException{
          BufferedReader buf=new BufferedReader(new InputStreamReader(System.in));
          int i,a=0,b=0,c=0;
          String str;
        ...
        public static  void coco(String name[],String sex[],String yo[],String id[])throws IOException{
          BufferedReader buf=new BufferedReader(new InputStreamReader(System.in));
          char ch;
          String e;
          do{
        ...
        public static void choice(String name[],String sex[],String yo[],String id[])throws IOException{
          ...
          switch(i){
            case 1:
            choice1(name,sex,yo,id);
            break;
            case 2:
            choice2(name,sex,yo,id);
            break;
            case 3:
            choice3(name,sex,yo,id);
            }
        }
        public static void choice1(String name[],String sex[],String yo[],String id[])throws IOException{
          int i;
          for(i=0;i<name.length;i++){
          System.out.println("姓名:"+name[i]+"，性別:"+sex[i]+"，就讀"+yo[i]+"，學號為"+id[i]);	
                }
        ...
        public static void choice2(String name[],String sex[],String yo[],String id[])throws IOException{
          int a=0,b=0,i;
        ...
        public static void choice3(String name[],String sex[],String yo[],String id[])throws IOException{
          int a=0,b=0,c=0,i;
